...
# Dhoose scenario in line 17. Scenarios are taken accoding to
# the function GetScenarioParams
####################################################################################
rm(list = ls())
...
setwd("CausalSemiCompReproduce/Nonparametric/Results/Scenario 3/cens10/")
my.files <- list.files()
